...
void Menu::menuEjemplares(Biblioteca &bib)
{
    ...
    while (opcion != 8)
    {
        ...
        case 1:
            limpiarPantalla();
            try{
                bib.ingresarEjemplar(ingresaEjemplar(bib)); //arreglar esto, incluir un puntero de bib en menu
            }catch (const char* e){                         //que cada clase tenga si metodo de cargar datos
                cout<<e<<endl;
            }
